(function ($) {
    ...
    function bwsplit_text() {
        setTimeout(function () {
            var splitTextElements = $(".sec-title__title, .sec-title__tagline, .page-header__title, .hero-two__title, .hero-one__title, .contact-one__title, .about-one__title, .expertise-one__sec-title, .hero-three__title, .hero-three__tagline, .hero-three__experience, .hero-four__title, .main-footer-two__tagline, .main-footer-two__title, .contact-page__title");
